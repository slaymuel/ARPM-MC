...
/*
    for(int k = 1; k <= numOfReflections; k += 2){
        ...
        for(int i = particles.numOfParticles; i < particles.numOfParticles + particles.numOfElectrons / 2; i++){
        ...
        for(int i = particles.numOfParticles + particles.numOfElectrons / 2; i < particles.numOfParticles + particles.numOfElectrons; i++){
...
/*
    for(int k = 1; k <= numOfReflections; k += 2){
        for(int j = 0; j < particles.numOfParticles + particles.numOfElectrons; j++){
