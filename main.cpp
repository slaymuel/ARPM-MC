...
int main(int argc, char *argv[])
{
    ...
    p->pos = (double*) malloc(3 * sizeof(double));
    p->pos[0] = 7.0;
    p->pos[1] = 8.0;
    p->pos[2] = 9.0;
    ...
    for(i = 0; i < numOfParticles; i++){
        ...
        particles[i]->pos[1] = (double) rand()/RAND_MAX * xL;
        particles[i]->pos[2] = (double) rand()/RAND_MAX * xL;
    }
